...
public class ScoreEditingScreen extends Screen {
    ...
    public ScoreEditingScreen(Screen parent, @NotNull Scoreboard scoreboard, @NotNull ScoreboardObjective objective) {
        ...
        this.parent = parent;
        this.scores = scoreboard.getAllPlayerScores(objective).stream().map(score -> new SingleScore(score.getPlayerName(), score.getScore())).collect(Collectors.toList());
    ...
    private List<ScoreModification> getScoreModifications(Scoreboard sb, ScoreboardObjective objective) {
        ...
        List<SingleScore> list = sb.getAllPlayerScores(objective).stream().map(score -> new SingleScore(score.getPlayerName(), score.getScore())).toList();
